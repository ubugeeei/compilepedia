...
@alloc12 = private unnamed_addr constant <{ ptr, [8 x i8] }> <{ ptr @alloc11, [8 x i8] c"\0C\00\00\00\00\00\00\00" }>, align 8
@alloc4 = private unnamed_addr constant <{}> zeroinitializer, align 8
@alloc42 = private unnamed_addr constant <{ [75 x i8] }> <{ [75 x i8] c"/rustc/a37499ae66ec5fc52a93d71493b78fb141c32f6b/library/core/src/fmt/mod.rs" }>, align 1
@alloc43 = private unnamed_addr constant <{ ptr, [16 x i8] }> <{ ptr @alloc42, [16 x i8] c"K\00\00\00\00\00\00\00\8C\01\00\00\0D\00\00\00" }>, align 8
...
@alloc8 = private unnamed_addr constant <{ [4 x i8] }> <{ [4 x i8] c"\10\A4\00\00" }>, align 4
...
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h350582a2f5dc30f1E(ptr sret(%"core::fmt::Arguments") %_16, ptr align 8 @alloc12, i64 1, ptr align 8 @alloc4, i64 0)
  br label %bb5

bb5:                                              ; preds = %bb4
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17h7b7052d3c2786c22E(ptr %_16, ptr align 8 @alloc43) #5
  unreachable
}
...
; call core::fmt::ArgumentV1::new_display
  %0 = call { ptr, ptr } @_ZN4core3fmt10ArgumentV111new_display17h4b4f71e626bb4d9eE(ptr align 4 @alloc8)
  %_10.0 = extractvalue { ptr, ptr } %0, 0
  %_10.1 = extractvalue { ptr, ptr } %0, 1
  br label %bb1

bb1:                                              ; preds = %start
  %1 = getelementptr inbounds [1 x { ptr, ptr }], ptr %_9, i64 0, i64 0
  %2 = getelementptr inbounds { ptr, ptr }, ptr %1, i32 0, i32 0
  store ptr %_10.0, ptr %2, align 8
  %3 = getelementptr inbounds { ptr, ptr }, ptr %1, i32 0, i32 1
  store ptr %_10.1, ptr %3, align 8
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h350582a2f5dc30f1E(ptr sret(%"core::fmt::Arguments") %_2, ptr align 8 @alloc5, i64 2, ptr align 8 %_9, i64 1)
  br label %bb2

bb2:                                              ; preds = %bb1
; call std::io::stdio::_print
  call void @_ZN3std2io5stdio6_print17h683a0ea6e0aa2e7dE(ptr %_2)
  br label %bb3
