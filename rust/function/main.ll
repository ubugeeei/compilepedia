...
@alloc43 = private unnamed_addr constant <{ [7 x i8] }> <{ [7 x i8] c"main.rs" }>, align 1
@alloc44 = private unnamed_addr constant <{ ptr, [16 x i8] }> <{ ptr @alloc43, [16 x i8] c"\07\00\00\00\00\00\00\00\09\00\00\00\05\00\00\00" }>, align 8
...
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h350582a2f5dc30f1E(ptr sret(%"core::fmt::Arguments") %_16, ptr align 8 @alloc11, i64 1, ptr align 8 @alloc3, i64 0)
  br label %bb5

bb5:                                              ; preds = %bb4
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17h7b7052d3c2786c22E(ptr %_16, ptr align 8 @alloc42) #7
  unreachable
}
...
; call main::hun_mul
  %0 = call i32 @_ZN4main7hun_mul17h8274e0b2825bd086E(i32 5)
  store i32 %0, ptr %y, align 4
  br label %bb1

bb1:                                              ; preds = %start
; call core::fmt::ArgumentV1::new_display
  %1 = call { ptr, ptr } @_ZN4core3fmt10ArgumentV111new_display17h4b4f71e626bb4d9eE(ptr align 4 %y)
...
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h350582a2f5dc30f1E(ptr sret(%"core::fmt::Arguments") %_5, ptr align 8 @alloc4, i64 2, ptr align 8 %_12, i64 1)
  br label %bb3
...
; main::hun_mul
; Function Attrs: uwtable
define internal i32 @_ZN4main7hun_mul17h8274e0b2825bd086E(i32 %n) unnamed_addr #1 {
start:
  %0 = call { i32, i1 } @llvm.smul.with.overflow.i32(i32 %n, i32 100)
...
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h3fff72c26c16101cE(ptr align 1 @str.1, i64 33, ptr align 8 @alloc44) #7
  unreachable
}
...
; Function Attrs: cold noinline noreturn uwtable
declare void @_ZN4core9panicking5panic17h3fff72c26c16101cE(ptr align 1, i64, ptr align 8) unnamed_addr #3
